...
function firstQuestion(){
    ...
    Swal.fire({
        ...
        imageUrl: 'a.jpg',
        background: '#fff url("cuteCat.jpg"")',
        ...
        if (result.value) {
            ...
            Swal.fire({
                title: 'hello ghệ đẹp ',
                text: 'Chúc b có 1 ngày 20/10 vui vẻ , mau lớn , xinh đẹp hơn, mau hết bệnh , và đặc biệt là nhớ seooo phì nhiều để gửi mình:>',
                                    ...
                                    Swal.fire({
                                        ...
                                        if (result.value) {
                                            ...
                                            Swal.fire({
                                                ...
                                                background: '#fff url("iput-bg.jpg")',
                                                title: 'Chúc bạn 1 ngày 20/10 vui vẻ không quạo nha🥰😘😘',
